<?php $this->assign('title', 'About Feast | ' . h($currentEntity['portal_title'])); ?>
...
<ul>
    <li>A focused PRA exercise which provides an overview of the farming system with particular emphasis on livestock feed aspects.</li>
