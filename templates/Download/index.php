            ...
            <?php if (isset($currentEntity['switch_shiny_download']) && isset($currentEntity['shiny_download']) && $currentEntity['switch_shiny_download'] == 1) { ?>
                <div role ='tabpanel' class='tab-pane active col-md-8' id='download-pane'>
                    <div class='page-prompt row'>
                        <h2 class='col-md-9'>DOWNLOAD > DOWNLOAD DATA SETS</h2>
                        <div class='col-md-3 pull-right'>
                            <input id="shiny" name="shiny" type="hidden" value="1" />
                            <a target='_blank' class="btn btn-success" data-bind="attr: {href: getData}">Download my data</a>
                        </div>
                    </div>
                    <div class="row">
            ...
            <?php } else { ?>
                <div role ='tabpanel' class='tab-pane active col-md-8' id='download-pane'>
                    <div class='page-prompt row'>
                        ...
                        <p class='col-md-7'>Download aggregated data sets in various formats. To access your data only, including data being kept private, use the My Data Only checkbox.</p>
                    </div>
...
<?php $this->Html->script('download.js?v=1.1', array('block' => 'script')) ?>
